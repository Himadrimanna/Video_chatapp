    ...
    <div className=" ">
      ...
      <div className="relative h-screen ">
        ...
        <div className="absolute h-full w-full flex overflow-hidden">
          <img src={conf} className="object-cover  w-full h-full" alt="" />
        </div>
        {/* Overlay */}
        ...
        <div className="lg:flex lg:pt-20 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
          ...
          <div className=" flex flex-col items-center justify-center pb-8">
            <h1 className="text-[40px] md:text-[80px] text-white font-bold pt-12">
              Video Chat App
            </h1>
          ...
          >
            ...
            <button
              type="submit"
              className=" bg-blue-500 hover:bg-blue-400 duration-100 ease-out font-bold w-[10rem] md:w-[7rem] rounded-3xl py-[5px] md:py-[7px] mt-2 md:mt-4 "
            >
              Enter Room
            </button>
          </form>
